...
public class RideStateMachine {
    ...
    private static final Map<RideStatus, Set<RideStatus>> transitions = Map.of(
            ...
            RideStatus.ACCEPTED, Set.of(RideStatus.ARRIVING, RideStatus.CANCELLED),
            RideStatus.ARRIVING, Set.of(RideStatus.ON_TRIP),
            RideStatus.ON_TRIP, Set.of(RideStatus.COMPLETED)
    );
